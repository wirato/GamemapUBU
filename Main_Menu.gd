...
func _ready():
	...
	$Level_Select_Menu/Button_Level_ubu.connect("pressed", self, "level_select_menu_button_pressed", ["ubu"])
...
func level_select_menu_button_pressed(button_name):
	...
	elif button_name == "ubu":
		set_mouse_and_joypad_sensitivity()
		get_node("/root/Globals").load_new_scene(ubu)
